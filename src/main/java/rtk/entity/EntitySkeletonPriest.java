...
public class EntitySkeletonPriest extends EntityMob {
    ...
    public boolean attackEntityAsMob(Entity target) {
        ...
        if (hit) {
            ...
            target.addVelocity(dir.xCoord, dir.yCoord, dir.zCoord);
        }
    ...
    public void onLivingUpdate() {
        ...
        List<EntitySkeleton> mobs = worldObj.getEntitiesWithinAABB(EntitySkeleton.class, getEntityBoundingBox().expand(30, 10, 30));
        for(EntitySkeleton mob: mobs){
            ...
            mob.setLastAttacker(getLastAttacker());
        }
        ...
        EntitySkeleton mob = new EntitySkeleton(worldObj);
        mob.setSkeletonType(SkeletonType.NORMAL);
    ...
    public BlockPos pickSpawnPoint(){
        for(int i = 0; i < 60; i++){
            ...
            for(int j = 0; j < 10; j++){
                if(worldObj.isSideSolid(pos.down(), EnumFacing.UP) && worldObj.isAirBlock(pos) && worldObj.isAirBlock(pos.up()))
                    return pos;
                pos = pos.up();
            }
        }
...
//    }
    ...
    class EntityAIFollowPriest extends EntityAIBase {
        ...
        public boolean shouldExecute() {
            return theEntity.getDistanceSqToEntity(priest) > maxDist * maxDist;
        }
